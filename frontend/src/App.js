...
function App() {
  ...
  useEffect(() => {
    axios.get("http://3.109.153.234:8086/backend-0.0.1-SNAPSHOT/getitem").then((response) => {
  ...
  useEffect(() => {
    axios.get("http://3.109.153.234:8086/backend-0.0.1-SNAPSHOT/user").then((response) => {
      console.log(response);
