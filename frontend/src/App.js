...
function App() {
  ...
  useEffect(() => {
    axios.get("http://43.204.115.27:8087/backend-0.0.1-SNAPSHOT/getitem").then((response) => {
  ...
  useEffect(() => {
    axios.get("http://43.204.115.27:8087/backend-0.0.1-SNAPSHOT/user").then((response) => {
      console.log(response);
