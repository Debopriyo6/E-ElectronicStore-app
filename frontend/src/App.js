...
function App() {
  ...
  useEffect(() => {
    axios.get("http://ac5d9752a1ea04fe58d11c4de4d971b3-1053839847.ap-south-1.elb.amazonaws.com:8089/backend-0.0.1-SNAPSHOT/getitem").then((response) => {
  ...
  useEffect(() => {
    axios.get("http://ac5d9752a1ea04fe58d11c4de4d971b3-1053839847.ap-south-1.elb.amazonaws.com:8089/backend-0.0.1-SNAPSHOT/user").then((response) => {
      console.log(response);
