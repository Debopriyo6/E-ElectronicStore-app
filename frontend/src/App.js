...
function App() {
  ...
  useEffect(() => {
    axios.get("http://3.110.204.171:8083/backend-0.0.1-SNAPSHOT/getitem").then((response) => {
  ...
  useEffect(() => {
    axios.get("http://3.110.204.171:8083/backend-0.0.1-SNAPSHOT/user").then((response) => {
      console.log(response);
