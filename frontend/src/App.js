...
function App() {
  ...
  useEffect(() => {
    axios.get("http://13.201.168.180:8087/backend-0.0.1-SNAPSHOT/getitem").then((response) => {
  ...
  useEffect(() => {
    axios.get("http://13.201.168.180:8087/backend-0.0.1-SNAPSHOT/user").then((response) => {
      console.log(response);
